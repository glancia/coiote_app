...
//                     var state = device.state.listen((event) {
//                       getCharacteristic(device, event);
//                     });
//                   };
//                   text = 'CONNECT';
//                   break;
...
// //                   .map((d) => (Row(children: [
// //                         Icon(Icons.bluetooth_disabled),
// //                         Text(d.name.substring(d.name.length-5))
// //                       ])))
// //                   .toList())));
// // }
//
...
// }
//
// getCharacteristic(device, state) async {
//   final x = state;
//   final y = null;
//
// }
...
//   String buffer = "";
//   if (devices.length > 0) {
//     devices[0].requestMtu(128);
//     List<BluetoothService> services = await devices[0].discoverServices();
//     services.forEach((service) async {
//       List<BluetoothCharacteristic> characteristics = service.characteristics;
//       for (BluetoothCharacteristic c in characteristics) {
//         if (c.properties.notify) {
//           BluetoothCharacteristic notifyC = c;
//           await c.setNotifyValue(true);
//           notifyC.value.listen((value) {
//             buffer += utf8.decode(value);
//             try {
//               var payload = jsonDecode(buffer);
//               print("dentro da função: " + payload);
//               return buffer;
//             } catch (error) {
//
//             }
...
//           BluetoothCharacteristic writeC = c;
//           await writeC.write(utf8.encode("get status"));
//         }
